    ...
    <div class="bg-gray-50 min-h-screen py-12">
        <div class="max-w-7xl mx-auto px-8">
            ...
            <div class="text-center mb-16">
                ...
                <p class="text-gray-500 max-w-2xl mx-auto">Temukan ribuan koleksi buku terbaik yang dikelompokkan
                    berdasarkan minat dan kebutuhan membaca Anda.</p>
            </div>
                ...
                @foreach($categories as $category)
                    <a href="{{ route('category.show', $category->id) }}" class="group">
                        <div
                            ...
                            <div
                                class="w-16 h-16 bg-indigo-50 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-indigo-600 transition-colors duration-300">
                                <i
                                    class="{{ $category->icon ?? 'fa-solid fa-book-open' }} text-2xl text-indigo-400 group-hover:text-white transition-colors"></i>
                            </div>
                            ...
                            <div
                                class="mt-6 text-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity flex items-center text-sm font-bold">
