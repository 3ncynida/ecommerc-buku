        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="flex flex-col md:row flex-wrap md:flex-nowrap">
                ...
                <div class="md:w-2/3 p-8 md:p-12">
                    ...
                    <div class="mb-8">
                        <h3 class="font-bold text-gray-800 mb-6">Detail Buku</h3>
                        <div class="grid grid-cols-2 gap-8">
                            @if ($item->publisher)
                            <div>
                                <p class="text-sm text-gray-500 mb-1">Penerbit</p>
                                <p class="font-semibold text-gray-900">{{ $item->publisher }}</p>
                            </div>
                            @endif
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">{{ $item->publication_year }}</p>
                            </div>
                            @endif
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-gray-900">{{ $item->isbn }}</p>
                            </div>
                            @endif

                            @if ($item->pages)
                            <div>
                                <p class="text-sm text-gray-500 mb-1">Halaman</p>
                                <p class="font-semibold text-gray-900">{{ $item->pages }}</p>
                            </div>
                            @endif

                            @if ($item->language)
                            <div>
                                <p class="text-sm text-gray-500 mb-1">Bahasa</p>
                                <p class="font-semibold text-gray-900">{{ $item->language }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
