...
<body class="bg-gray-100 flex">
    ...
    <aside class="w-64 bg-indigo-900 text-white min-h-screen sticky top-0">
        ...
        <nav class="mt-6 px-4 space-y-2">
            <a href="#" class="block py-2.5 px-4 rounded transition bg-indigo-700">
                <i class="fa-solid fa-gauge mr-2"></i> Dashboard
            </a>
            <a href="{{ route('categories.index') }}" class="block py-2.5 px-4 rounded transition hover:bg-indigo-800">
