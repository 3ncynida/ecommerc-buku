    ...
    <div class="bg-white rounded-[24px] shadow-sm border border-slate-200/60 overflow-hidden">
        ...
        <div class="p-6 md:p-8 border-b border-slate-100 bg-slate-50/50">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="text-xl font-black text-slate-900 tracking-tight">Tambah Kategori</h3>
                    <p class="text-[13px] font-medium text-slate-500 mt-1">Lengkapi form di bawah ini untuk menambahkan kategori baru ke dalam sistem.</p>
                </div>
            </div>
        </div>
