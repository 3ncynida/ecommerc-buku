            ...
            <tr class="hover:bg-gray-50 transition">
                ...
                <td class="px-6 py-4">
                    <div class="flex justify-center space-x-2">
                        <a href="#" class="text-blue-500 hover:bg-blue-50 p-2 rounded-lg transition">
                            <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                        <form action="{{ route('categories.destroy', $category) }}" method="POST">
                            @csrf @method('DELETE')
                            <button class="text-red-500 hover:bg-red-50 p-2 rounded-lg transition" onclick="return confirm('Hapus data ini?')">
