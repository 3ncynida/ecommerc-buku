        ...
        <div class="flex items-center gap-3">
            ...
            <div class="relative flex-1 max-w-[640px]">
                ...
                <input type="text" id="search-input"
                    ...
                    placeholder="Cari judul buku, penulis..." autocomplete="off">
                ...
                <div class="relative shrink-0" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
                        ...
                        <div class="px-6 py-4 flex items-center space-x-4">
                            <div
                                class="w-12 h-12 bg-indigo-50 rounded-full flex items-center justify-center overflow-hidden">
                        ...
                        <div class="px-2 space-y-1">
                            <a href="{{ route('profile.edit') }}"
                                ...
                                <i
                                    class="fa-solid fa-chevron-right text-[10px] text-gray-300 group-hover:text-indigo-600"></i>
                            </a>
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                ...
                                <button type="submit"
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <i
                                            class="fa-solid fa-right-from-bracket text-gray-400 group-hover:text-red-500"></i>
                                        <span class="text-sm font-medium text-gray-700 group-hover:text-red-500">Keluar
                                            Akun</span>
                                    </div>
                                    <i
                                        class="fa-solid fa-chevron-right text-[10px] text-gray-300 group-hover:text-red-500"></i>
                                </button>
                            </form>
                        </div>
                    </div>
